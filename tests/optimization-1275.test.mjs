...
test("1.27.8.6 size guard detects missing categories and significant individual-file growth while preserving accurate accounting", async () => {
  ...
  for (const browser of ["firefox", "chrome"]) {
    ...
    assert.equal(actual.version, "1.27.8.6");
