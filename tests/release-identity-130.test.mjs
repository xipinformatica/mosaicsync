...
test("1.30 has one exact release identity across public/runtime surfaces", () => {
  ...
  const releaseNotes = fs.readFileSync("docs/RELEASE-1.31.4.md", "utf8");
  const qa = fs.readFileSync("docs/QA-1.31.4.md", "utf8");
