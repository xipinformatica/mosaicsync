...
test("1.30 has one exact release identity across public/runtime surfaces", () => {
  ...
  const releaseNotes = fs.readFileSync("docs/RELEASE-1.30.18.23.md", "utf8");
  const qa = fs.readFileSync("docs/QA-1.30.18.23.md", "utf8");
...
test("1.30 public changelog keeps internal candidates out of the public release sequence", () => {
  ...
  assert.deepEqual(headings.slice(0, 25), [VERSION, "1.30.18.22", "1.30.18.21", "1.30.18.20", "1.30.18.19", "1.30.18.18", "1.30.18.17", "1.30.18.16", "1.30.18.15", "1.30.18.14", "1.30.18.13", "1.30.18.12", "1.30.18.11", "1.30.18.10", "1.30.18.9", "1.30.18.8", "1.30.18.7", "1.30.18.6", "1.30.18.5", "1.30.18.4", "1.30.18.3", "1.30.18.2", "1.30.18.1", "1.30.18", "1.30.17"]);
});
