# MosaicSync 1.26.10 manual QA

## Version / packaging
- Confirm Settings displays `MosaicSync · 1.26.10` in Firefox and Chrome.
- Confirm Firefox/Chrome manifests, Chrome `version_name`, internal `VERSION`, build manifest and package filenames all report `1.26.10`.
