# MosaicSync 1.26.6 manual QA

## Release identity
- Confirm Settings displays `MosaicSync · 1.26.6` in Firefox and Chrome.
- Confirm Firefox/Chrome manifests, Chrome `version_name`, internal `VERSION`, build manifest and package filenames all report `1.26.6`.
