# MosaicSync 1.26.11 manual QA

## Version / packaging
- Confirm Settings displays `MosaicSync · 1.26.11` in Firefox and Chrome.
- Confirm Firefox/Chrome manifests, Chrome `version_name`, internal `VERSION`, build manifest and package filenames all report `1.26.11`.
...
## Frequently visited disclosure
- With **Show** off, confirm **Number shown** and the device-local status line are not visible.
- Turn **Show** on and grant permission; confirm both controls appear immediately after enablement.
- Turn **Show** off again; confirm both controls disappear without closing Settings.
